...
public class DumbestTest {
    public static void main(String[] args) {
        ...
        double optimalCost = DumbestDecoder.runPureAStar(map); 
        ...
        List<Point> greedyPath = DumbestDecoder.getGreedyPath(map);
        ...
        int mutationMode = Chromosome2.MUTATION_HYBRID;
        ...
        for (int gen = 1; gen <= maxGenerations; gen++) {
            ...
            if (stagnationCount > patienceThreshold){
                System.out.println("\n>>> ☠️ STAGNATION DETECTED! TRIGGERING MASS EXTINCTION ☠️ <<<");
                System.out.println(">>> Keeping the best survivor (Fitness: " + best.fitness + ") and killing the rest...");
        ...
        // Final Result
        // --------------------------------------------------------
        Chromosome2 solution = population.get(0);
        System.out.println("------------------------------");
        ...
        DumbestDecoder.calculateFitness(map, solution, solutionPath);
